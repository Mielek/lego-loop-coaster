...
class LiftStateMachine(StateMachine):
  ...
  move_down = at_top.to(moving_down)
  stop_at_bottom = moving_down.to(at_bottom)

  stop_at_middle_1 = moving_up.to(at_middle_1)
  stop_at_middle_2 = moving_up.to(at_middle_2)
  stop_at_middle_3 = moving_up.to(at_middle_3)
  stop_at_middle_4 = moving_up.to(at_middle_4)
  stop_at_middle_5 = moving_up.to(at_middle_5)
